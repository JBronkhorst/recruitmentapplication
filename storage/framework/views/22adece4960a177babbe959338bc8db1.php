...
<?php $__env->startSection('content_logged_in'); ?>
    <form class="flex items-center max-w-sm mx-auto mt-10" type="GET" action="<?php echo e(url('/search/vacancies')); ?>">
                ...
                <?php $__empty_1 = true; $__currentLoopData = $vacancies; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $vacancy): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                    <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700">
                        ...
                        <button class="bg-blue-400 hover:bg-blue-500 rounded-lg shadow px-10 text-sm h-10 mr-5">
                            <a class="nav-link text-white w-max" href="/vacancies/<?php echo e($vacancy->id); ?>/view">View</a>
                        </button>
                        </td>
                    </tr>
...
<?php echo $__env->make('layouts.loggedin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\jbron\job-portal-app\resources\views/search.blade.php ENDPATH**/ ?>