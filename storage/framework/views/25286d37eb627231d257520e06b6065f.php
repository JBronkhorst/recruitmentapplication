...
<?php $__env->startSection('content_logged_in'); ?>
    ...
    <form class="flex items-center max-w-sm mx-auto mt-10" type="GET" action="<?php echo e(url('/vacancies/search')); ?>">
            ...
            <tbody>
                <?php $__empty_1 = true; $__currentLoopData = $vacancies; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $vacancy): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                    <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700">
                        <td scope="row" class="px-6 py-4"><?php echo e($vacancy->title); ?></td>
                        <td class="px-6 py-4"><?php echo e($vacancy->location); ?></td>
                        <td class="px-6 py-4"><?php echo e($vacancy->job_type); ?></td>
                        <td class="px-6 py-4">
                            <button class="col-start-11 col-span-1 bg-orange-400 hover:bg-orange-500 rounded-lg shadow mr-9">
                                <a class="nav-link text-white" href="/vacancies/<?php echo e($vacancy->id); ?>/edit">
                        ...
                        <td class="px-6 py-4">
                            <form method="POST" action="/vacancies/<?php echo e($vacancy->id); ?>">
                                <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.loggedin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\jbron\job-portal-app\resources\views/vacancy/index.blade.php ENDPATH**/ ?>