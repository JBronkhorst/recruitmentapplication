...
@section('content_logged_in')
    <form class="flex items-center max-w-sm mx-auto mt-10" type="GET" action="{{ url('/search/vacancies') }}">
                ...
                @forelse($vacancies as $vacancy)
                    <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700">
                        ...
                        <button class="bg-blue-400 hover:bg-blue-500 rounded-lg shadow px-10 text-sm h-10 mr-5">
                            <a class="nav-link text-white w-max" href="/vacancies/{{ $vacancy->id }}/view">View</a>
                        </button>
                        </td>
                    </tr>
                @empty
