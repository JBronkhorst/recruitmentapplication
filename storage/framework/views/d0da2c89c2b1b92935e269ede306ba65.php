...
<?php $__env->startSection('content_logged_in'); ?>
    <form class="flex items-center max-w-sm mx-auto mt-10" type="GET" action="<?php echo e(url('/users/search')); ?>">
            ...
            <tbody>
                <?php $__currentLoopData = $users; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $user): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700">
                        <td scope="row" class="px-6 py-4"><?php echo e($user->id); ?></td>
                        ...
                        <?php endif; ?>
                        <td class="px-6 py-4">
                            <form class="col-start-11 col-span-1" method="POST" action="/users/<?php echo e($user->id); ?>">
                                <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.loggedin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\jbron\job-portal-app\resources\views/user/index.blade.php ENDPATH**/ ?>